...
* <button class="autocomplete__clear" type="button" aria-controls=${autocompleteEl.id} title="Clear input">
...
/**
* Attach the clear button and corresponding event listeners to the autocomplete instance
*
...
class Autocomplete {
	...
	*/
	constructor (autocompleteEl, options) {
		...
		container.classList.add('autocomplete__listbox-container');
	...
	*/
	...
	/**
	* Initialise autocomplete component/s.
	*
