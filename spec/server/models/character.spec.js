	...
	describe('show method', () => {
		...
		it('will get show data', done => {
			...
			instance.show().then(result => {
				expect(stubs.Base.cypherTemplatesShared.getShowQueries.character.calledOnce).to.be.true;
				expect(stubs.Base.cypherTemplatesShared.getShowQueries.character.calledWithExactly()).to.be.true;
				expect(stubs.Base.dbQuery.calledOnce).to.be.true;
				expect(stubs.Base.dbQuery.calledWithExactly(
