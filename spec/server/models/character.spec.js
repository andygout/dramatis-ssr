...
const createSubject = (stubOverrides = {}) =>
	proxyquire('../../../dist/models/character', {
		...
		'../lib/cypher-templates/character': stubs.cypherTemplatesCharacter,
	...
	describe('show method', () => {
		...
		it('will get show data', done => {
			...
			instance.show().then(result => {
				expect(stubs.cypherTemplatesCharacter.getShowQuery.calledOnce).to.be.true;
				expect(stubs.cypherTemplatesCharacter.getShowQuery.calledWithExactly()).to.be.true;
				expect(stubs.dbQuery.calledOnce).to.be.true;
				expect(stubs.dbQuery.calledWithExactly(
